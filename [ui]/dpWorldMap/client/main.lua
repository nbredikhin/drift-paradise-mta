...
local function drawCuboid(position, size, direction, materialWall, materialTop)
	math.randomseed(position:getSquaredLength())
...
addEventHandler("onClientRender", root, function ()
	drawHorizontalPlane(Vector3(0, 0, 2.35), Vector2(70, 70), 90, pixel, tocolor(50 * muls[1], 50 * muls[2], 50 * muls[3], 255))
	drawHorizontalPlane(Vector3(0, 0, 2.4), Vector2(40, 40), 90, map, tocolor(255 * muls[1], 255 * muls[2], 255 * muls[3]))
