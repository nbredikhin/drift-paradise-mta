...
--	[ид модели] = {engine = "звук мотора", blowoff = "звук blowoff", gear = "звук понижения передачи", downTime = как быстро опускается до 0 оборотов мотор в милисекундах, coeff = коэффициент скорости звука мотора },
	...
	[474] = {engine = "180sx.wav",gear = "gear.wav",blowoff = "BlowoffCivic.wav", downTime = 2000, coeff = 10000, volume = 0.2},
    ...
    [496] = {engine = "rx8.wav",gear = "gear.wav",blowoff = "BlowoffCivic.wav", downTime = 2000, coeff = 10000, volume = 0.2},
